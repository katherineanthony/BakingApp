...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void wireWidgets() {
        editTextUsername = findViewById(R.id.editText_registration_username);
        editTextPassword = findViewById(R.id.editText_registration_password);
        editTextName = findViewById(R.id.editText_registration_name);
        editTextEmail = findViewById(R.id.editText_registration_email);
        editTextConfirmPassword = findViewById(R.id.editText_registration_confirmPassword);
        buttonCreateAccount = findViewById(R.id.button_registration_createAccount);
    }
}
